...
interface CodesCiiuProps {
    onSelectCodeCiiu: (codeCiiu: string) => void;
}

function CodesCiiu({ onSelectCodeCiiu }: CodesCiiuProps) {
    ...
    const handleCiiuCodeChange = (selectedOption: any) => {
        ...
        onSelectCodeCiiu(selectedOption.value);
    };
    ...
    const codesCiiu: { value: string; label: string }[] = [
        ...
        { value: "2593", label: "2593 - Fabricación de artículos de cuchillería, HERRAMIENTASs de mano y artículos de ferretería" },
        ...
        { value: "2818", label: "2818 - Fabricación de HERRAMIENTASs manuales con motor" },
        ...
        { value: "2822", label: "2822 - Fabricación de máquinas formadoras de metal y de máquinas HERRAMIENTAS" },
